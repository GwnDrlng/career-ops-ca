...
> 「`modes/i18n/ja/` の日本語モードを使って。」

または

> 「評価と応募を日本語で。`modes/i18n/ja/_shared.md` と `modes/i18n/ja/kyujin.md` を読んで。」
